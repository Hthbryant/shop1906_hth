...
<div class="shop_goods_bd clear">
    ...
    <div class="shop_goods_show">
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="${goods.fengmian}" jqimg="${goods.fengmian}" width="350">
                </div>
                <div id="spec-n5">
                    <!-- 封面图-->
        ...
        <div class="shop_goods_show_right">
            <ul>
                ...
                <li>
                    <label>秒杀价格：</label>
                    <span><strong>${goods.goodsMiaosha.miaoshaPrice?string("￥#,###.##")}</strong>元</span>
                </li>
                <li>
                    <label>剩余库存：</label>
                    <span>${goods.goodsMiaosha.miaoshaStorage}件</span>
                </li>
                <li class="goods_num">
                    <label>购买数量：</label>
                    <span>
                ...
                <li style="padding:20px 0;">
                    <label>&nbsp;</label>
                    <span><strong style="color: red;">距离秒杀开始还剩:<a id="daojishi"> 00:00:00</a></strong></span><br/>
                    <lable>&nbsp;</lable>
                    <span><button id="start_btn" disabled="disabled">即将开始</button></span><br/>
                </li>
            </ul>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function djs() {
            ...
            var hour= parseInt(temp/1000/60/60);
            var minute = parseInt(temp/1000/60%60);
            var second = parseInt(temp/1000%60);
            var ms = parseInt(temp%1000);
            var ht = timeFormat(hour)+":"+timeFormat(minute)+":"+timeFormat(second);
            setTimeout(function () {
